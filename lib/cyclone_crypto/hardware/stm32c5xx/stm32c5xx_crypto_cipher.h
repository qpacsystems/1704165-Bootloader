/**
 * @file stm32c5xx_crypto_cipher.h
...
#ifndef _STM32C5XX_CRYPTO_CIPHER_H
#define _STM32C5XX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32C5XX_CRYPTO_CIPHER_SUPPORT
   #define STM32C5XX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32C5XX_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32C5XX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32C5XX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
...
//CPHASE bitfield
#define AES_CR_CPHASE_INIT         0
#define AES_CR_CPHASE_HEADER       AES_CR_CPHASE_0
#define AES_CR_CPHASE_PAYLOAD      AES_CR_CPHASE_1
#define AES_CR_CPHASE_FINAL        (AES_CR_CPHASE_1 | AES_CR_CPHASE_0)
