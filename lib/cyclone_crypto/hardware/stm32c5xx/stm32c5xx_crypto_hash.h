/**
 * @file stm32c5xx_crypto_hash.h
 * @brief STM32C5 hash hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32C5XX_CRYPTO_HASH_H
#define _STM32C5XX_CRYPTO_HASH_H

//Dependencies
#include "core/crypto.h"

//Hash hardware accelerator
#ifndef STM32C5XX_CRYPTO_HASH_SUPPORT
   #define STM32C5XX_CRYPTO_HASH_SUPPORT DISABLED
#elif (STM32C5XX_CRYPTO_HASH_SUPPORT != ENABLED && STM32C5XX_CRYPTO_HASH_SUPPORT != DISABLED)
   #error STM32C5XX_CRYPTO_HASH_SUPPORT parameter is not valid
#endif
