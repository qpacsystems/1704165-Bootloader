...
#ifndef _STM32C5XX_CRYPTO_PKC_H
#define _STM32C5XX_CRYPTO_PKC_H

//Dependencies
#include "core/crypto.h"

//Public-key hardware accelerator
#ifndef STM32C5XX_CRYPTO_PKC_SUPPORT
   #define STM32C5XX_CRYPTO_PKC_SUPPORT DISABLED
#elif (STM32C5XX_CRYPTO_PKC_SUPPORT != ENABLED && STM32C5XX_CRYPTO_PKC_SUPPORT != DISABLED)
   #error STM32C5XX_CRYPTO_PKC_SUPPORT parameter is not valid
#endif
...
//PKA RAM
#define PKA_RAM ((volatile uint32_t *) PKA->RAM)
